  ...
  render() {
    return (
      <ComponentWrapper>
          ...
          <p>Technology-wise, this is a web app that I've built with React and designed myself. It's a fun little side project where I test out new technologies like styled-components, and practise bits of JavaScript that I'd like to get better at. The photos of geese are all ones that I've taken myself, and the info about the different types of geese is from Wikipedia and the RSPB website.</p> 
      </ComponentWrapper>
    );
  }
}
